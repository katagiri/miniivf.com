<?php $offset = '../'; require ($offset.'includes/inc_lib.php'); $page = 'why'; ?>
...
<div class="content">
    ...
    <p>In addition to health and cost effectiveness, Mini-IVF&trade; yields high success rates, comparable to those found with conventional IVF.  Moreover, while in some cases, the success rate per cycle for conventional IVF can be higher, it is because a conventional IVF cycle typically transfers more than one embryo, risking multiple pregnancies and more dangerous births. , Mini-IVF&trade; allows high success rates with single embryo transfers to reduce the risks associated with multiple pregnancies and allow you to have more control over your cycle.</p>
    </div>
